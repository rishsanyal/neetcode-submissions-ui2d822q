...
Q: Why isn't the cache key index, OPERATION?
A: Because what we're tracking is curr_sum == target AND we can reach index, operation in multiple ways from the start. The curr sum will be different at those points
